...
class Login extends StatelessWidget {
  ...
  _buildLoginButton(BuildContext context, Map<String, String> data,
    ...
    if (reactiveModel.state.isLoading) {
      ...
      return RaisedButton(
        ...
        onPressed: () => _loginPressed(context, data, key, reactiveModel),
      );
    }
  }
  ...
  _loginPressed(BuildContext context, Map<String, String> data,
      GlobalKey<FormState> key, ReactiveModel reactiveModel) {
    ...
    if (form.validate()) {
      ...
      reactiveModel.setState((controller) => controller.login(context, data));
    }
  }
